...
export default function LayerControls({ onToggleLayer, heatmapTimeFilter = '7d', onHeatmapTimeFilterChange }: LayerControlsProps) {
  ...
  const layerInfo = [
    { key: 'floodZones' as const, label: 'Vùng ngập lụt', icon: faWater, color: 'bg-blue-500', iconColor: 'text-blue-500' },
    { key: 'outageZones' as const, label: 'Vùng mất điện', icon: faBolt, color: 'bg-red-500', iconColor: 'text-red-500' },
    { key: 'userReports' as const, label: 'Báo cáo người dùng', icon: faLocationDot, color: 'bg-purple-500', iconColor: 'text-purple-500' },
    { key: 'safeZones' as const, label: 'Điểm an toàn', icon: faHospital, color: 'bg-green-500', iconColor: 'text-green-500' },
    { key: 'routes' as const, label: 'Tuyến đường', icon: faRoad, color: 'bg-orange-500', iconColor: 'text-orange-500' },
    { key: 'heatmap' as const, label: 'Bản đồ nhiệt', icon: faFire, color: 'bg-gradient-to-r from-yellow-400 to-red-600', iconColor: 'text-red-600' },
  ];
