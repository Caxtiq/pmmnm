...
export const safeZones: SafeZone[] = [
  ...
  },
  {
    ...
    phone: '024 3823 3881',
    facilities: ['Nơi trú ẩn tạm thời', 'Nhà vệ sinh', 'Nước sạch', 'Điện', 'Wifi'],
    available: true
  },
  {
    id: 'sz-3',
  ...
  },
  {
    ...
    phone: '024 3768 2020',
    facilities: ['Diện tích rộng', 'Hệ thống điều hòa', 'Điện dự phòng', 'Bãi đỗ xe'],
    available: true
  },
  {
    id: 'sz-5',
    ...
    phone: '024 3825 4854',
    facilities: ['Điều phối khẩn cấp', 'Trung tâm chỉ huy', 'Thông tin liên lạc'],
    available: true
  },
  {
    id: 'sz-6',
  ...
  },
  {
    ...
    type: 'hospital',
    location: [105.8448, 21.0230],
    capacity: 700,
    address: '40 Tràng Thi, Hoàn Kiếm, Hà Nội',
    phone: '024 3825 3531',
    facilities: ['Cấp cứu ngoại khoa', 'Phẫu thuật', 'ICU', 'Bệnh viện chất lượng cao'],
    available: true
  }
];
...
export function findNearestSafeZones(
  ...
  return zones
    .map(zone => ({
      ...zone,
      distance: calculateDistance(location[1], location[0], zone.location[1], zone.location[0])
    }))
...
export function getSafeZoneColor(type: SafeZone['type']): string {
  switch (type) {
    ...
    case 'shelter': return '#3b82f6'; // blue
    case 'high_ground': return '#10b981'; // green
    case 'government': return '#8b5cf6'; // purple
